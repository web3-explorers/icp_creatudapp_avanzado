...
document.title = "Reversi en Internet Computer";
  ...
  return {
    ...
    view: function (vnode) {
      ...
      if (game === null) {
        ...
        content = Board(
          expiring ? "El juego va a expirar si nadie hace un movimiento!" : "",
          player_color,
          next_color,
          game,
          boards,
...
function Tips() {
  ...
  let tips = [
    [
      m("h4", "Cómo jugar:"),
      m("ul", [
        m("li", "Primer jugador tendrá el color negro."),
        m("li", "Segundo jugador tendrá el color blanco."),
        m("li", "No se requiere password."),
      ]),
    ],
    [
      m("h4", "Invitar a un amigo:"),
      m("ol", [
        m("li", ["Ingresa los nombres de ambos y haz clic en ", m("i", "Jugar!")]),
        m("li", "Cuando ya estés en el juego, copia el link del navegador y compártelo"),
      ]),
    ],
    [
      m("h4", "Cómo conseguir puntos:"),
      m("ol", [
        m("li", "Por ganar el juego."),
        m("li", "Por ganar a mejores competidores!"),
      ]),
    ],
    [
      m("h4", "Invitar a alguien:"),
      m("ol", [
        m("li", ["Deja el nombre de tu oponente en blanco y haz clic en ", m("i", "Jugar!")]),
        m("li", "Ya en el juego, comparte el link del navegador."),
      ]),
    ],
  ];
  var games = [];
...
function Play() {
  ...
  return {
    ...
    view: function (vnode) {
      ...
      if (inited) {
        var title = "Bienvenido a reversi!";
        var score = m("h2");
        var form = [];
        ...
        form.push(m("label.label", "Elige un oponente"));
        form.push(
        ...
        form.push(m("button.button[type=submit]", "Jugar!"));
        return [
          m("div.top-centered", [
            m("h1", title),
            m("img.logo", { src: logo }),
          ...
          m(
            ...
            m(
              "a",
              { href: "https://github.com/web3-explorers/icp_creatudapp_avanzado" },
              "Código fuente"
            )
          ),
        ];
